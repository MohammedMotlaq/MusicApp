...
import 'musicui.dart';
class Watch_UI extends StatefulWidget {
  const Watch_UI({Key? key}) : super(key: key);

  @override
  State<Watch_UI> createState() => _Watch_UIState();
}

class _Watch_UIState extends State<Watch_UI> {
  int index = 1;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Lottie.asset('assets/animations/disconnected.json',width: 150,height: 150),
            Text("Couldn't connect to the network",style: TextStyle(fontSize: 15,),),
            Text("Check your network settings and try again",style: TextStyle(fontSize: 10),),
            Text('\n\n\n\n'),
          ],
        ),
      ),
